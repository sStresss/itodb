...
class Ui_OGroupTransfer(QDialog):
    ...
    def runUi(self):
        ...
        self.cb_ParentObjName.setGeometry(QtCore.QRect(150, 50, 201, 22))
        self.cb_ParentObjName.setObjectName("cb_ParentObjName")
        self.cb_ChildObjName = QtWidgets.QComboBox(self.frame)
        self.cb_ChildObjName.setGeometry(QtCore.QRect(150, 80, 201, 22))
    ...
    def MakeOTransfer(self):
        ...
        if GlobalValues.MesResult == True:
            ...
            with con:
                ...
                for elem in GlobalValues.otbl_selected_lst:
...
if __name__ == "__main__":
    uiOGroupTransfer = Ui_OGroupTransfer()
    uiOGroupTransfer.show()
    sys.exit(app.exec_())
